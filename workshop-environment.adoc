...
*Keycloak* がベース
* 他にも、オープンソースプロジェクトが由来の、  https://knative.dev[Knative^] （サーバーレスアプリ）、 https://jenkins.io/[Jenkins^] や https://cloud.google.com/tekton/[Tekton^] （CI/CDパイプライン）、https://prometheus.io[Prometheus^] や https://grafana.com[Grafana^] （モニタリングアプリ）などがあります。
